...
__all__ = [ 'OLE_XSIZE_CONTAINER', 'StdPicture', 'Unchecked',
           'IPictureDisp', 'VgaColor', 'IFontEventsDisp',
           'OLE_YSIZE_CONTAINER', 'OLE_TRISTATE', 'OLE_XSIZE_PIXELS',
           'Default', 'OLE_YSIZE_HIMETRIC', 'FONTNAME',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XPOS_CONTAINER', 'Picture',
           'FONTITALIC', 'OLE_YSIZE_PIXELS', 'OLE_COLOR', 'FONTBOLD',
           'Font', 'OLE_YPOS_CONTAINER', 'StdFont',
           'FONTSTRIKETHROUGH', 'FONTSIZE', 'OLE_CANCELBOOL',
           'IPicture', 'OLE_HANDLE', 'FontEvents', 'Gray',
           'LoadPictureConstants', 'IFont', 'OLE_OPTEXCLUSIVE',
           'FONTUNDERSCORE', 'Checked', 'OLE_XPOS_HIMETRIC',
           'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_PIXELS',
           'OLE_YPOS_HIMETRIC', 'IFontDisp', 'OLE_XPOS_PIXELS',
           'Monochrome', 'Color']
from comtypes import _check_version; _check_version('1.1.10', 1247529555.877464)
